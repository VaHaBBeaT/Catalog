...
namespace Catalog
{
    public partial class form_EditBook : Form
    {
        ...
        private void FillInfo(Book book)
        {
            ...
            foreach (var path in book.picPath)
            {
